...
![Exponent close](https://github.com/d3clane/labs/blob/Lab5/Lab5/ReadmeAssets/imgs/ExponentClose.png)
...
![Sum chars close](https://github.com/d3clane/labs/blob/Lab5/Lab5/ReadmeAssets/imgs/SumClose.png)
...
Сумма букв $sum$ $'a' * 5 \le sum \le 'z' * 20$, то есть $485 \le sum \le 2440$ - тоже сильно ограниченная хеш-функция. 
