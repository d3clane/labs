...
data1 = np.loadtxt('../TestsResults/Point5/HoareCenter.out', delimiter=' ')
x1, y1 = data1[:, 0], data1[:, 1]

data2 = np.loadtxt('../TestsResults/Point5/HoareRnd.out', delimiter=' ')
...
plt.figure()
plt.plot(x1, y1, 'b-', label='center pivot')
plt.plot(x2, y2, 'r-', label='random pivot')
...
plt.savefig('imgs/QuickSortPivots.png')